...
\begin{document}
    ...
    \begin{center}
        \boxed{\Bigg[ \gamma^{\mu} \frac{\slashed{p} + m}{2m} \gamma^{\rho} \frac{\slashed{p} + m}{2m} \Bigg] = \frac{1}{m^2} [p_{1 \mu} p'_{1 \rho} - 4 p_1 \cdot p'_1 g_{\mu \nu} + p_{1 \rho} p'_{1 \mu} + m^2 g_{\mu \rho}]}
    \end{center}
    ...
    \begin{center}
        \boxed{\Bigg[ \gamma^{\mu} \frac{\slashed{p} + m}{2m} \gamma^{\rho} \frac{\slashed{p} + m}{2m} \Bigg] = \frac{1}{m^2} [p_{2}^{\mu} p_{2}^{' \rho} - 4 p_2 \cdot p'_2 g^{\mu \nu} + p_{2}^{\rho} p_{2}^{' \mu} + m^2 g^{\mu \rho}]}
    \end{center}
